...
const vpsKeywords = `(?i)aws|google|华为云|dmit`;
...
function buildCountryProxyGroups(countryList) {
    const countryIconURLs = {
        ...
        "Cloudflare": "https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Cloudflare.png",
    };
    // 获取实际存在的地区列表
...
function buildProxyGroups(countryList, countryProxyGroups, lowCost) {
    ...
    return [
        ...
        },
        {
            ...
            "type": "select",
            "include-all": true,
            "proxies": (hasCF) ? ["Cloudflare节点", "节点选择", "手动切换", "全球直连"] : defaultProxies,
        },
        {
            "name": "人工智能",
