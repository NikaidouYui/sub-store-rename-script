...
function parseCountries(config) {
  ...
  for (const [country, pattern] of Object.entries(countryRegex)) {
    compiledRegex[country] = new RegExp(pattern.replace(/^\(\?i\)/, ""), "i");
  }
...
function buildCountryProxyGroups(countryList) {
  const countryIconURLs = {
    ...
    加拿大:
      "https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Canada.png",
    澳大利亚:
      "https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Australia.png",
    德国: "https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Germany.png",
    俄罗斯:
      "https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Russia.png",
    ...
    马来西亚:
      "https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Malaysia.png",
...
function buildProxyGroups(countryList, countryProxyGroups, providerProxyGroups, lowCost) {
  ...
  const hasCF = countryList.includes("Cloudflare");
  return [
    {
      name: "节点选择",
